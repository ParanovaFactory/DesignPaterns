...
namespace DesignPatern.Observer.Migrations
{
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    discauntId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    dicauntCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    dicauntAmount = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    dicauntCodeStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_discaunts", x => x.discauntId);
                });
