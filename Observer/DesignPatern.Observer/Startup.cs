...
namespace DesignPatern.Observer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ObserverObject>(sp =>
            {
                ...
                observerObject.RegisterObserver(new ObserverPatern.WelcomeMessage(sp));
                observerObject.RegisterObserver(new CreateMagazineAnnouncement(sp));
                observerObject.RegisterObserver(new CreateDiscauntCode(sp));
